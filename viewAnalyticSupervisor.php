    ...
    <header>
      ...
      <main>
        <div class="container-fluid">
            ...
            <br>
          <div id="numEmp">
            <h6>No. of employees of each FWA status </h6>
            ...
            <table class="table table-bordered table-hover table-light">
                ...
                <?php
                  ...
                  $conn = mysqli_connect($server, $username, $password, $dbname);
                    ...
                    //query to get the department ID of the logged in supervisor belongs to
                    $sqlDept = "SELECT departmentID FROM employee WHERE employeeID = '$employeeID'";
                    $resultDept = mysqli_query($conn, $sqlDept);
                    $rowDept = mysqli_fetch_assoc($resultDept);
                    $deptID = $rowDept['departmentID'];

                  //sql query to get the count of employees of each FWA status from the department that the supervisor belongs to,
                  //and assign column alias to the COUNT expression
                  $sql = "SELECT departmentID,
                          ...
                          FROM employee WHERE departmentID = '$deptID' GROUP BY departmentID";
