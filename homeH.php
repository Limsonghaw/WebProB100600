            ...
            <div class="offcanvas-body">
                <nav id="sidebarMenu">
                    <div class="list-group">
                        <a href="homeH.php" class="list-group-item list-group-item-action active" aria-current="true">
                          Dashboard
                        </a>
        ...
        <div class="container-fluid" id="home">
          <div class="row">
              <div class="col-sm-6 col-md-6 col-lg-6">
                ...
                <button class="homeBtn" onclick='location.href="RegisterEmployee.php"'> Register Employee </button> <br>
                <button class="homeBtn" onclick='location.href="viewAnalytics.php"'> FWA Analytics </button>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-6">
