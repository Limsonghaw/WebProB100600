            ...
            <div class="offcanvas-body">
                <nav id="sidebarMenu">
                    <div class="list-group">
                        <a href="homeS.php" class="list-group-item list-group-item-action active" aria-current="true">
                          Dashboard
                        </a>
        ...
        <div class="container-fluid" id="home">
          <div class="row">
              <div class="col-sm-6 col-md-6 col-lg-6">
                <button class="homeBtnS" onclick='parent.location="#info"'> Profile </button> <br>
                <button class="homeBtnS" onclick='location.href="reviewFWA.php"'> FWA Request </button> <br>
                <button class="homeBtnS" onclick='location.href="reviewS.php"'> EMP Schedule </button> <br>
                <button class="homeBtnS" onclick='location.href="viewAnalyticSupervisor.php"'> FWA Analytics </button>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-6">
